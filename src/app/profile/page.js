  ...
  return (
    <>
      <div className="bg-teal-200">
          ...
          <div className="flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
            ...
            <div className="w-full px-2">
              <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
                {/* {user.sailer ? (
                  ...
                  <div className="relative group">                    
                    ...
                    <div
                      className="absolute left-0 mt-2 w-40 bg-white rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-150 z-10"
                    >
                      <ul className="py-1">
                        <li>
                          <a
                ...
                <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="./profile/updateprofile">
                  ...
                  <span className="ml-2 text-sm font-medium">Manage Account</span>
                </a>
              ...
              <div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
                ...
                <a className="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300"
                  href="#">
                  <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
        ...
        <div>
          <div>
            <section className="w-full overflow-hidden ml-12 dark:bg-gray-950">
              <div className="flex flex-col">
                <img src="https://as2.ftcdn.net/jpg/02/24/04/47/1000_F_224044746_FYTyIESlYO71jHTgFrYR9GYGHquTEgYK.jpg" alt="User Cover"
                  className="w-full h-full object-cover" />
                {/* <!-- Profile Image --> */}
                <div className="sm:w-[80%] xs:w-[90%] mx-auto flex">
                  <img src="https://images.pexels.com/photos/771742/pexels-photo-771742.jpeg" alt="User Profile"
                  ...
                  <div className="w-full my-auto py-6 flex flex-col justify-center gap-2">
                      ...
                      <div className="w-full">
                        <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                          ...
                          <div className="flex flex-col py-3">
                            ...
                            <dd className="text-lg font-semibold">{user.dob}</dd>
                          </div>
                          <div className="flex flex-col py-3">
                    ...
                    <div className="my-10 lg:w-[70%] md:h-[14rem] xs:w-full xs:h-[10rem]">
                      ...
                      <iframe
                        ...
                        className="rounded-lg w-230 h-50" style={{ border: 0 }} aallowfullscreen="" loading="lazy"
