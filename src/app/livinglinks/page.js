  ...
  return (
    <>
      <section className="flex flex-col w-full h-screen ">
        ...
        <div className="w-full h-screen relative ">
          <div className="relative h-screen text-center flex flex-col justify-center items-center">
            {/* <h1 className="font-normal text-7xl text-center mt-20 text-white capitalize">
          Explore the Best Flats for Rent</h1> */}
            {/* <h1 className="font-normal text-5xl text-center mt-2 text-white capitalize"> Your New Home Awaits.</h1> */}
            <h1 className="font-normal text-5xl text-center mt-2 text-white capitalize"> Affordable Living, Exceptional Spaces.</h1>
      ...
      <div className="mt-1 ml-5 mr-5 flex flex-wrap justify-center">
        {/* <div className="rid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-center mt-8"> */}
        {propertys?.map((item) => (
          <div className="flex flex-col justify-center items-center ml-2 mr-2" key={item._id}>
            <div className="relative flex flex-col my-6 bg-white shadow-sm border border-slate-200 rounded-lg w-96">
              ...
              <div className="px-4 pb-4 pt-0 mt-2">
                <Link href={`./livinglinks/${item._id}`}
